"""
sim_eleventh_floor.launch.py
===========================
Launch file for Hector SLAM simulation on the 11th Floor college environment.
"""
...
def generate_launch_description():
    ...
    spawn_robot = Node(
        ...
        arguments=[
            ...
            "-x", "0.0",
            "-y", "0.0",
            "-z", "0.5",  # Spawn slightly higher to avoid floor collision
        ],
    )
